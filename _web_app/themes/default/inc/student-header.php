...
echo '<link rel="stylesheet" href="'.$currentGradsFolder . $graduatingStudentFolderName  .'/_web_app/themes/'.$theme .'/css/simple-css-reset.css?v=2" media="all" />';
}
else {echo '<link rel="stylesheet" href="' . $currentGradsFolder . $graduatingStudentFolderName  .'/_web_app/themes/'. $theme .'/css/normalize.css" media="all" />';
}

?>


<link rel="stylesheet" href="<?php echo $currentGradsFolder . $graduatingStudentFolderName  ?>/_web_app/themes/<?php echo $theme ?>/css/style.css?v=2" media="all" />

<script src="<?php echo $currentGradsFolder . $graduatingStudentFolderName  ?>/_web_app/themes/<?php echo $theme ?>/js/modernizr-3.6.0.min.js"></script>


<meta name="robots" content="noodp, noydir" />

<meta property="author" content="<?php echo $graduatingStudentName ?>">
